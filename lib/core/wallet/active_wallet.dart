...
// Read-only shortcut for screens that don't want the full bloc/repository graph
// just to look up "who am I right now."
class ActiveWallet {
  ActiveWallet._();
  static final _store = WalletAccountsStore();

  // Unwrapped here rather than by each caller, so there is one place that can
  // throw MnemonicLockedException and one place to get it right.
