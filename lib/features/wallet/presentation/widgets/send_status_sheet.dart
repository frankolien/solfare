  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Close button (hidden during sending to prevent premature close)
          Align(
          ...
          SizedBox(
            ...
            height: 100,
            child: status == 'sending'
                ? Lottie.asset('assets/assets/lottie/send_loop.json', repeat: true)
                : status == 'success'
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Save address', style: TextStyle(color: Colors.black, fontSize: 14, fontFamily: 'FKGrotesk', fontWeight: FontWeight.w600)),
                  ),
                ),
              ),
