...
class MarketHomeState extends Equatable {
  ...
  /// Sections whose source did not answer.
  ...
  /// True before anything at all has arrived, which is the only moment a full-
  /// screen skeleton is the right answer.
  bool get isEmpty => sections.values.every((tokens) => tokens.isEmpty);

  /// Everything the home has seen, by mint.
